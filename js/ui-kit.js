...
const FCMS_I18N = {
  en: {
    ...
    login: "Login",
    voucher_receipt_required:
      "Voucher / Receipt is required before saving this allocation.",
    receipt_bill_required:
      "Receipt / Bill is required before saving this expense.",
    allocation_exceeds_office_balance:
      "Allocation cannot exceed the Main Office available balance of {amount}.",
    allocation_below_existing_expenses:
      "This allocation cannot be reduced below the committee's existing expenses of {amount}.",
    expense_exceeds_available_balance:
      "Expense cannot exceed the committee's available allocated balance of {amount}.",
    no_allocated_funds_expense:
      "This Sub Committee has no allocated funds, so an expense cannot be recorded.",
    allocation_delete_blocked:
      "This allocation cannot be deleted because {amount} has already been spent by this Sub Committee.",
  },
  ml: {
    ...
    login: "ലോഗിൻ",
    voucher_receipt_required:
      "വൗച്ചർ / രസീത് അപ്‌ലോഡ് ചെയ്യാതെ വിഹിതം സേവ് ചെയ്യാൻ കഴിയില്ല.",
    receipt_bill_required:
      "രസീത് / ബിൽ അപ്‌ലോഡ് ചെയ്യാതെ ചെലവ് സേവ് ചെയ്യാൻ കഴിയില്ല.",
    allocation_exceeds_office_balance:
      "വിഹിതം മെയിൻ ഓഫീസിന്റെ ലഭ്യമായ ബാക്കി തുകയായ {amount} കവിയാൻ കഴിയില്ല.",
    allocation_below_existing_expenses:
      "ഈ വിഹിതം കമ്മിറ്റി ഇതിനകം ചെലവാക്കിയ {amount}-ൽ താഴെയാക്കാൻ കഴിയില്ല.",
    expense_exceeds_available_balance:
      "ചെലവ് കമ്മിറ്റിക്ക് ലഭ്യമായ വിഹിത ബാക്കി തുകയായ {amount} കവിയാൻ കഴിയില്ല.",
    no_allocated_funds_expense:
      "ഈ സബ് കമ്മിറ്റിക്ക് വിഹിതം അനുവദിച്ചിട്ടില്ല. അതിനാൽ ചെലവ് രേഖപ്പെടുത്താൻ കഴിയില്ല.",
    allocation_delete_blocked:
      "ഈ വിഹിതം ഇല്ലാതാക്കാൻ കഴിയില്ല. ഈ സബ് കമ്മിറ്റി ഇതിനകം {amount} ചെലവഴിച്ചിട്ടുണ്ട്.",
  },
};
function fcmsLang() {
...
(function () {
  function skipStaleSavedFormOnBack() {
    try {
      ...
      if (
        saved?.path !== current ||
        Date.now() - Number(saved.at || 0) > 120000
      ) {
        if (Date.now() - Number(saved?.at || 0) > 120000)
...
const FCMS_ML_TEXT = {
  ...
  "Fund Collection": "ഫണ്ട് കളക്ഷൻ",
  "Fund Collection Management System": "ഫണ്ട് കളക്ഷൻ മാനേജ്‌മെന്റ് സിസ്റ്റം",
  "Main Committee": "മെയിൻ കമ്മിറ്റി",
  "Sub Committee": "സബ് കമ്മിറ്റി",
  "Sub Committees": "സബ് കമ്മിറ്റികൾ",
  Dashboard: "ഡാഷ്ബോർഡ്",
  "Activity History": "പ്രവർത്തന ചരിത്രം",
  Reports: "റിപ്പോർട്ടുകൾ",
  Donations: "സംഭാവനകൾ",
  Members: "അംഗങ്ങൾ",
  Collections: "പിരിവുകൾ",
  ...
  "Review Hold Payments": "താൽക്കാലിക പേയ്മെന്റുകൾ പരിശോധിക്കുക",
  ...
  "That receipt number is already in use.":
    "ഈ രസീത് നമ്പർ ഇതിനകം ഉപയോഗിച്ചിട്ടുണ്ട്.",
  "This receipt number is already in use.":
    "ഈ രസീത് നമ്പർ ഇതിനകം ഉപയോഗിച്ചിട്ടുണ്ട്.",
  "Please select a member and fill in all required fields.":
    "ഒരു അംഗത്തെ തിരഞ്ഞെടുത്ത് ആവശ്യമായ വിവരങ്ങൾ പൂരിപ്പിക്കുക.",
  ...
  "What was this spent on?": "എന്തിനാണ് ഈ തുക ചെലവാക്കിയത്?",
  ...
  "Search name, phone or house number":
    "പേര്, ഫോൺ അല്ലെങ്കിൽ വീട്ടുനമ്പർ തിരയുക",
  ...
  "Office Amount Remaining After Expenses":
    "ചെലവുകൾക്ക് ശേഷം ഓഫീസിന്റെ ബാക്കി തുക",
  ...
  "Yes / വേണം": "വേണം",
  "No / വേണ്ട": "വേണ്ട",
  "For members 21+ / 21 വയസും അതിൽ കൂടുതലുമുള്ളവർക്ക് മാത്രം":
    "21 വയസും അതിൽ കൂടുതലുമുള്ളവർക്ക് മാത്രം",
  ...
  Details: "വിശദാംശങ്ങൾ",
  "Search member, receipt or action":
    "അംഗം, രസീത് അല്ലെങ്കിൽ പ്രവർത്തനം തിരയുക",
  "Search donor, house, receipt or Pradeshikam":
    "ദാതാവ്, വീട്, രസീത് അല്ലെങ്കിൽ പ്രദേശം തിരയുക",
  "Search receipt, member or phone": "രസീത്, അംഗം അല്ലെങ്കിൽ ഫോൺ തിരയുക",
  "Search name, phone or house number":
    "പേര്, ഫോൺ അല്ലെങ്കിൽ വീട്ടുനമ്പർ തിരയുക",
  ...
  "No activity recorded yet.":
    "ഇതുവരെ പ്രവർത്തനങ്ങളൊന്നും രേഖപ്പെടുത്തിയിട്ടില്ല.",
  "No matching member": "പൊരുത്തപ്പെടുന്ന അംഗമില്ല",
  Male: "പുരുഷൻ",
  Female: "സ്ത്രീ",
  ...
  root.querySelectorAll("[placeholder],[title],[aria-label]").forEach((el) => {
    ["placeholder", "title", "aria-label"].forEach((a) => {
      if (el.hasAttribute(a))
        el.setAttribute(a, fcmsTranslateValue(el.getAttribute(a)));
    });
  });
}
    ...
    mutations.forEach((m) =>
      m.addedNodes.forEach((node) => {
        if (node.nodeType === 1) applyFcmsMalayalamToDom(node);
          ...
          const v = fcmsTranslateValue(node.nodeValue);
          if (v !== node.nodeValue) node.nodeValue = v;
        }
      }),
    );
  });
  window.__fcmsMlObserver.observe(document.body, {
    childList: true,
    subtree: true,
  });
