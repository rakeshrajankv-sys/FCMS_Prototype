...
${pageTitle("Add Payment","Record another installment for "+escapeHTML(member.name))}
...
document.getElementById("paymentForm").addEventListener("submit",e=>{
 ...
 if(amount===0 && Number(member.requiredAmount)>0){err.textContent="Enter a valid payment amount.";err.classList.remove("d-none");return}
