...
<div class="col-md-4"><label class="form-label">Sub Committee *</label><select id="allocCommittee" class="form-select" required>${db.subCommittees.map((c) => `<option value="${c.id}">${escapeHTML(c.name)}</option>`).join("")}</select></div>
<div class="col-md-4"><label class="form-label">Amount *</label><input id="allocAmount" type="number" min="1" step="1" class="form-control" required></div>
<div class="col-md-4"><label class="form-label">Date *</label><input id="allocDate" type="date" class="form-control" required></div>
<div class="col-md-6"><label class="form-label">Collected By (Name) *</label><input id="allocName" class="form-control" required placeholder="Who collected this?"></div>
<div class="col-md-6"><label class="form-label">Collected By (Phone) *</label><div class="phone-field"><select id="allocPhoneCode" class="form-select"><option value="+91">+91</option><option value="+971">+971</option></select><input id="allocPhone" class="form-control" type="tel" inputmode="numeric" maxlength="10" required placeholder="10-digit number"></div></div>
<div class="col-12"><label class="form-label">Remarks</label><input id="allocRemarks" class="form-control"></div>
