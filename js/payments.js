...
${pageTitle("Payments","Every installment is stored as a separate receipt.")}
...
function render(){
 ...
 document.getElementById("paymentTable").innerHTML=!arr.length?`<div class="empty-state"><i class="bi bi-receipt"></i>No payments found.</div>`:
