  ...
  document
    ...
    .addEventListener("submit", (e) => {
      ...
      addActivity(db, {
        ...
        summary: `Donation ${receipt} edited`,
        details: "Donation details edited by Main Committee.",
        oldValue: old,
